...
import { isAdminAtom, userLoggedIn } from './state/state';
        ...
        <div>
            ...
            <main style={styles.main}>
                <Routes>
                    <Route
                        ...
                        element={
                            isLoggedIn ? ( isAdmin ? <AdminPage /> :
                                <Navigate to={`/${currentNav}`} />
                            ) : (
                                <LoginPage currentNav={currentNav} />
                            )
                        }
                    />
                    ...
                    <Route path="/login" element={isLoggedIn ? <Navigate to="/" /> : <LoginPage currentNav={currentNav} />} />
